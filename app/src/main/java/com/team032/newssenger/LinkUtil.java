...
public class LinkUtil {
    ...
    public static void getLinkPreview(final Context context, final String url, final GetLinkPreviewListener listener) {
...
//                    } else
                    ...
                    ChatMessage linkPreview = new ChatMessage();
    ...
    private static String getImageLink(Elements elements, String site) {
...
//            }
    ...
    private static boolean validateURL(String url) throws URISyntaxException, MalformedURLException {
        URL u = null;
        u = new URL(url);
        u.toURI();
        return true;
